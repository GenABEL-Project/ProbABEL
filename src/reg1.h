...
//Oct 26, 2009
        printf("In apply_model: nX.nrow: %i nX.ncol: %i\n", nX.nrow, nX.ncol);
...
{
 std::cout << "t_apply: ngpreds: " << ngpreds << "; model: "<< model<<"\n";
...
public:
        ...
        {
            std::cout << "in coxp_reg\n";
            printf("cdatain.X.nrow: %i cdata.in.X.ncol: %i\n", cdata.X.nrow, cdata.X.ncol);
